...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [4058500.084278, 6537371.857824, 4086116.508420, 6562714.281126], maxZoom: 18, minZoom: 12
    })
});
...
map.getView().fit([4058500.084278, 6537371.857824, 4086116.508420, 6562714.281126], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="">данные: Клевцова М.А.</a> &middot; ';
        var olAttribution = document.createElement('li');
        olAttribution.innerHTML = '<a href="">картография: Сарычев Д.В.</a> &middot; ';
        var qgisAttribution = document.createElement('li');
        qgisAttribution.innerHTML = '<a href="https://www.vsu.ru/ru/university/structure/faculties/geogr.html">ВГУ ГГиТ</a>';
