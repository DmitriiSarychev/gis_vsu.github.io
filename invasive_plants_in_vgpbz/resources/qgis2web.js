...
map.getView().fit([4413338.057915, 6777469.813192, 4415013.269857, 6778618.645937], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Карта фитоинвазий ВГПБЗ</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (696 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Карта фитоинвазий показывает места произрастания 28 чужеродных видов растений на центральной усадьбе Воронежского государственного природного биосферного заповедника им. В.М. Пескова (ВГПБЗ). Выявленные очаги распространения этих инвазивных видов представляют потенциальную угорзу естественным сообществам Усманского бора.<br />Данные собраны в июне 2024 г в рамках практики по биоиндикации и экологическому картографированию студентами 2 курса факультета географии, геоэкологии и туризма Воронежского государственного университета под руководством к.г.н., доц. Л.А. Лепешкиной (lilez1980@mail.ru), техническое обеспечение картографических работ и визуализация - Д.В. Сарычев (sarychev.geo@gmail.com).';
            }
...
map.on("rendercomplete", function(evt) {
	if (!attributionComplete) {
		...
		if (attributionList) {
			...
			qgis2webAttribution.innerHTML = '<a>скачать геоданные:</a> &middot; ';
			attributionList.appendChild(qgis2webAttribution);

			var olAttribution = document.createElement('li');
			olAttribution.innerHTML = '<a href="https://raw.githubusercontent.com/DmitriiSarychev/gis_vsu.github.io/main/invasive_plants_in_vgpbz/VGPBZ_InvasivePlants.xlsx">xlsx-таблица</a> &middot; ';
			attributionList.appendChild(olAttribution);

			var qgisAttribution = document.createElement('li');
			qgisAttribution.innerHTML = '<a href="https://raw.githubusercontent.com/DmitriiSarychev/gis_vsu.github.io/main/invasive_plants_in_vgpbz/VGPBZ_InvasivePlants.zip">QGIS-проект</a>';
